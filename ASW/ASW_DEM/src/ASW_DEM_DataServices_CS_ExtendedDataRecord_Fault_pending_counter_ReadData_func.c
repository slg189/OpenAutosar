...
/*PROTECTED REGION ID(FileHeaderUserDefinedIncludes :ASW_DEM_DataServices_CS_ExtendedDataRecord_Fault_pending_counter_ReadData_func) ENABLED START */
/* Start of user defined includes  - Do not remove this comment */
/* End of user defined includes - Do not remove this comment */
/*PROTECTED REGION END */

/*PROTECTED REGION ID(FileHeaderUserDefinedConstants :ASW_DEM_DataServices_CS_ExtendedDataRecord_Fault_pending_counter_ReadData_func) ENABLED START */
/* Start of user defined constant definitions - Do not remove this comment */
/* End of user defined constant definitions - Do not remove this comment */
/*PROTECTED REGION END */

/*PROTECTED REGION ID(FileHeaderUserDefinedVariables :ASW_DEM_DataServices_CS_ExtendedDataRecord_Fault_pending_counter_ReadData_func) ENABLED START */
...
FUNC (Std_ReturnType, AUTOMATIC) ASW_DEM_DataServices_CS_ExtendedDataRecord_Fault_pending_counter_ReadData_func/* return value & FctID */
(
