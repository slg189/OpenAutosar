 ...
 * uint32 allowed_security_b32;                      Allowed security levels\n
 * boolean (*moderule_fp) (uint8 * )\n
 * void (*adrServiceHandler_pfct) (Dcm_MsgContextType * );  Service handler\n
 * void (*adrServiceInit_pfct) (void);                  Init function of service\n
 ...
 * const uint8 * ptr_rxtable_pca                        :Reference to Rx table array\n
 * const PduIdType * ptr_txtable_pca                       :Reference to Tx table array\n
 * const Dcm_Dsld_connType * ptr_conntable_pcs           :Reference to Connection table structure\n
 * const Dcm_Dsld_protocol_tableType * protocol_table_pcs  :Reference to protocol table\n
 * const Dcm_Dsld_sid_tableType * sid_table_pcs     :Reference to sid table\n
 * const uint8 * session_lookup_table_pcau8            :Session look up table\n
 *  const uint8 * security_lookup_table_pcau8            :Security look up table.
 */
typedef struct
{
...
extern void Dcm_Prv_SetOBDNegResponse(const Dcm_MsgContextType* pMsgContext,Dcm_NegativeResponseCodeType ErrorCode);
#endif
