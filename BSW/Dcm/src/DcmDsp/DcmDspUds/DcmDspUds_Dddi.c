...
static Dcm_DddiWriteOrClear_ten s_isWriteOrClear_en; /* Enum to inform application whether it is a clear operation or Write operation */
#endif
#define DCM_STOP_SEC_VAR_CLEARED_UNSPECIFIED /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_16 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
uint16 Dcm_AddIdCurrentBlockIndex_u16;       /* Variable to store the index of the current block */

static uint16 s_ActiveDDDI_u16; /* DDDI for which the write and clear NvM APIs are called */
...
#include "Dcm_MemMap.h"
uint32 Dcm_AddIdCurrentLength_u32;            /* Variable to store the length of the DDDI */

static uint32 s_dataLength_u32; /* Variable to store the length of the DID */
#define DCM_STOP_SEC_VAR_CLEARED_32 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_8/*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
Dcm_OpStatusType Dcm_DspDddidOpStatus_u8;    /* Variable to store the opstatus*/
...
#define DCM_START_SEC_VAR_CLEARED_UNSPECIFIED/*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
static Dcm_DIDIndexType_tst s_Dcm_idxSrcDidIndexType_st;  /*Store the index of DID of either Dcm_DidConfig or Dcm_DIDRangeCOnfig structure*/
...
static Std_ReturnType Dcm_GetDynamicSignalConfiguration(uint16 DidIndex_u16)
{
    ...
    uint16 index_u16;          /* Local variable to loop through the DID signals                             */
    Std_ReturnType dataRetVal_u8;      /* Local variable to store the return value of the API                        */
    boolean stVariableLength_b; /* Local variable to store if the signal is the first variable length signal  */
	boolean FixedLength_b; /*Local variable to store the length type of signals*/
...
FixedLength_b=Dcm_DspDataInfo_st[Dcm_DIDConfig[DidIndex_u16].adrDidSignalConfig_pcst[index_u16].idxDcmDspDatainfo_u16].dataFixedLength_b;
        ...
        if(FixedLength_b==FALSE)
        {
            ...
            if(((Dcm_DspDataInfo_st[Dcm_DIDConfig[DidIndex_u16].adrDidSignalConfig_pcst[index_u16].idxDcmDspDatainfo_u16].usePort_u8 == USE_DATA_SYNCH_FNC) || \
                    ...
                    ((Dcm_DIDConfig[DidIndex_u16].adrExtendedConfig_pcst->dataAllowedSessRead_u32 >0x00u) && (Dcm_DspDid_ControlInfo_st[Dcm_DspDataInfo_st[Dcm_DIDConfig[DidIndex_u16].adrDidSignalConfig_pcst[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct.ReadDataLengthFnc1_pf != NULL_PTR)))

            {
                ...
                if(FALSE==Dcm_DIDConfig[DidIndex_u16].dataDynamicDid_b)
                {
                    ...
                    {
                        dataRetVal_u8 = (*(Dcm_DspDid_ControlInfo_st[Dcm_DspDataInfo_st[Dcm_DIDConfig[DidIndex_u16].adrDidSignalConfig_pcst[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct.ReadDataLengthFnc1_pf))(&dataSigLength_u16);
                    }
                    else
                    {
                        ...
                        {
                            dataRetVal_u8 = (*(Dcm_DspDid_ControlInfo_st[Dcm_DspDataInfo_st[Dcm_DIDConfig[DidIndex_u16].adrDidSignalConfig_pcst[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct.ReadDataLengthFnc4_pf))(s_Dcm_idxSrcDidIndexType_st.dataopstatus_b,&dataSigLength_u16);
                        }
                   }
                ...
                {
                    /* Get the length from the configured API */
                    dataRetVal_u8 = (*(Dcm_DspDid_ControlInfo_st[Dcm_DspDataInfo_st[Dcm_DIDConfig[DidIndex_u16].adrDidSignalConfig_pcst[index_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrReadDataLengthFnc_pfct.ReadDataLengthFnc2_pf))(&dataSigLength_u32);
...
void Dcm_DDDI_Ini (void)
{
    ...
    if((Dcm_DspDddidOpStatus_u8 == DCM_PENDING) && (Dcm_stAddIdRecords_en == DCM_DDDI_DEFINE_BY_ID_GETSUPPORT))
    {
        if(((Dcm_DspDataInfo_st[Dcm_DIDConfig[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].adrDidSignalConfig_pcst[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16 >0u) && (Dcm_DIDConfig[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].adrExtendedConfig_pcst->dataAllowedSessRead_u32 >0x00u))&&
                ((Dcm_DspDid_ControlInfo_st[Dcm_DspDataInfo_st[Dcm_DIDConfig[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].adrDidSignalConfig_pcst[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrCondChkRdFnc_cpv.CondChkReadFunc2_pfct)!= NULL_PTR)&&
        ...
        {
            dataCondChkRetVal_u8 = (*(Dcm_DspDid_ControlInfo_st[Dcm_DspDataInfo_st[Dcm_DIDConfig[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].adrDidSignalConfig_pcst[Dcm_DidSignalIdx_u16].idxDcmDspDatainfo_u16].idxDcmDspControlInfo_u16].adrCondChkRdFnc_cpv.CondChkReadFunc2_pfct))(DCM_CANCEL, &NegResCode_u8);
        }
    }
#if(DCM_CFG_DSP_DDDISTORINGTONVRAM_ENABLED != DCM_CFG_OFF)
...
{
    /*TRACE[SWS_Dcm_00259]*/
    uint8 dataSubFunction_u8;  /* static variable for storing the subfunction */
#if(DCM_CFG_DSP_DDDISTORINGTONVRAM_ENABLED != DCM_CFG_OFF)
    static uint16 s_idxIndexForStore_u16;  /* static varaible to store the index of the active DDDID for storing in NvM */
    Std_ReturnType dataRetValFromNvMStorage_u8;  /* Local variable to store the return value from the NvM storage/Clear */
#endif
    uint16 idxIndex_u16;
    ...
    dataRetValFromNvMStorage_u8 = E_OK;
        ...
        if (Dcm_DspStDddi_en==DCM_DDDI_IDLE)
        {
            ...
            if (dataSubFunction_u8==DCM_DDDI_CLEAR_DYNAMIC_IDENTIFIER)
            {
                ...
                uint32 idxRdpi_u32; /* Local variable to loop through the DDDIs configured */
#endif
            ...
            else if (dataSubFunction_u8==DCM_DEFINITION_BY_ID)
            {
                ...
                {
                    Std_ReturnType dataFuncRetVal_u8; /* Local variable to store the return value of function */
                    /* Get the DDDI from the request */
                    uint16 dataDid_u16 = (uint16)pMsgContext->reqData[1];
                    dataDid_u16  <<=  8u;
                    dataDid_u16   |= (uint16)pMsgContext->reqData[2];
                    ...
                    if (dataFuncRetVal_u8==E_OK)
                    {
                        Dcm_DIDIndexType_tst idxsrcDidIndexType_st; /*Store the index of DID of either Dcm_DidConfig or Dcm_DIDRangeCOnfig structure*/
                        /* Call the function to get the idxIndex_u16 of the DID from Dcm_DIDConfig*/
                        dataFuncRetVal_u8 = Dcm_Prv_GetIndexOfDID (dataDid_u16,&idxsrcDidIndexType_st);
#if(DCM_CFG_DSP_NUMISDIDAVAIL>0)
                ...
                if (pMsgContext->reqDataLen>=DCM_DDDI_MEMADDR_MINLEN)
                {
                    ...
                    else
                    {
                        ...
                        if ((dataReqMsgLen_u16%dataBlockLen_u8)==0)
                        {
                            ...
                            if (dataFuncRetVal_u8==E_OK)
                            {
                                Dcm_DIDIndexType_tst idxDidIndexType_st;    /*Store the index of DID of either Dcm_DidConfig or Dcm_DIDRangeCOnfig structure*/
                                /* Call the function to get the idxIndex_u16 of the DID from Dcm_DIDConfig*/
                                dataFuncRetVal_u8 = Dcm_Prv_GetIndexOfDID (dataDid_u16,&idxDidIndexType_st);
#if(DCM_CFG_DSP_NUMISDIDAVAIL>0)
                                /* Check if the DID is supported in current variant */
...
{
    Std_ReturnType dataRetVal_u8;
    Std_ReturnType dataReadIfcRetVal_u8; /* Local variable to store the return value of Read function */
#if(DCM_CFG_DSP_DIDBUFFER == DCM_STACK_BUFFER)
    uint8 Dcm_DspDidBuffer_au8[DCM_CFG_LONGESTSINGLEDID]; /* Temporary buffer to store data of record */
#else
        ...
        Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
    ...
    if(adrContext_pst->nrCurrentlyDefinedRecords_u16>0)
    {
                ...
                (dataRetVal_u8 == E_OK))
        {
            ...
            {
                Std_ReturnType dataFuncRetVal_u8; /* Local variable to store return value of API */
                uint16 dataLength_u16; /* Local variable to store length of record */
            ...
            {
                Dcm_ReadMemoryRet_t dataFuncRetVal_en; /* Local variable to store return value of API */
        ...
        Dcm_MsgLenType nrResponseBufferLen_u32)
{
    ...
    /*Local Variable to store Position of Record */
    ...
    if(dataRetValGetLen_u8==E_OK)
    {
        ...
        while ((Dcm_AddIdCurrentBlockIndex_u16<nrBlocks_u16) && (dataRetVal_u8==E_OK))
        {
            ...
            {
                /* Variable to store return value of function Dcm_Prv_GetIndexOfDID */
                Std_ReturnType dataFuncRetVal_u8;
                uint16 dataDid_u16;
#if(DCM_CFG_RDBIPAGEDBUFFERSUPPORT != DCM_CFG_OFF)
                uint16 idxLoop_u16;
                ...
                else
                {
                    ...
                    dataFuncRetVal_u8 = Dcm_Prv_GetIndexOfDID (dataDid_u16,&s_Dcm_idxSrcDidIndexType_st);
                    ...
                    if (dataFuncRetVal_u8==E_OK)
                    {
                        Dcm_DIDIndexType_tst idxsrcDidIndexType_st; /*Store the index of DID of either Dcm_DidConfig or Dcm_DIDRangeCOnfig structure*/
                        /* Call the function to get the idxIndex_u16 of the DID from Dcm_DIDConfig*/
                        dataFuncRetVal_u8 = Dcm_Prv_GetIndexOfDID (Dcm_DDDIBaseConfig_cast[idxIndex_u16].dataDddId_u16,&idxsrcDidIndexType_st);
                ...
                if (s_dataFunctionRetVal_u8==E_OK)
                {
                    ...
                    if(((s_dataLength_u32 <=  Dcm_DIDConfig[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].dataMaxDidLen_u16) && (FALSE== s_Dcm_idxSrcDidIndexType_st.dataRange_b)) ||((s_dataLength_u32 <=  Dcm_DIDRangeConfig_cast[s_Dcm_idxSrcDidIndexType_st.idxIndex_u16].dataMaxDidLen_u16)&& (FALSE != s_Dcm_idxSrcDidIndexType_st.dataRange_b )))
...
#endif
                        {
                            ...
                            /* Check if the posnInSourceDataRecord_u8 is zero or greater than maximum available in the DID*/
...
{
    Dcm_DIDIndexType_tst idxsrcDidIndexType_st; /*Store the index of DID of either Dcm_DidConfig or Dcm_DIDRangeCOnfig structure*/
    Std_ReturnType dataRetVal_u8;        /* Variable to store the return value of the function */
    Std_ReturnType stGetMemAccess_u8;   /* Variable to store the return value of the function DcmAppl_DcmGetPermissionForMemoryAccess_u8*/
    Std_ReturnType dataRetValGetLen_u8; /* Variable to store the return value of the API Dcm_DddiGetLen_u8 */
...
Std_ReturnType Dcm_DddiGetLen_u8 (const Dcm_DddiMainConfig_tst * adrConfig_pcst,
        uint32 * adrLen_pu32)
{
    uint32 idxCurrentRecord_u16 = 0; /* Variable to store current record idxIndex_u16 */
    Dcm_DddiIdContext_tst * adrContext_pst;
    Std_ReturnType dataRetVal_u8 = E_OK;
...
Std_ReturnType Dcm_DddiGetCondition_u8(const Dcm_DddiMainConfig_tst * adrConfig_pcst,
        Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
    Std_ReturnType dataRetVal_u8=E_OK; /* Variable to store the return value */
            ...
            (dataRetVal_u8 == E_OK))
    {
        ...
        {
            Dcm_SupportRet_t dataSupportInfo_en;
            Dcm_DIDIndexType_tst idxDidCondIndexType_st;    /*Store the index of DID of either Dcm_DidConfig or Dcm_DIDRangeCOnfig structure*/
        ...
        {
            Std_ReturnType dataFuncRetVal_u8; /* Variable to store the return value */
 ...
 *******************************************************************************************************************************************************************
 */
/*TRACE[BSW_SWS_AR4_2_R2_DiagnosticCommunicationManager_Ext-3535]*/
