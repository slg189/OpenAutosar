...
static Dcm_DspRequestDownloadStates_ten Dcm_stDspStateRequestDownload_en;   /* RequestDownload state */
#define DCM_STOP_SEC_VAR_CLEARED_UNSPECIFIED /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_32 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
static uint32 Dcm_dataMemoryAddress_Download_u32; /*Variable to store the memory address requested by the tester*/
static uint32 Dcm_dataMemoryLength_u32;  /*Variable to store the memory length requested by the tester*/
#define DCM_STOP_SEC_VAR_CLEARED_32 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"

static uint8 Dcm_dataMemdatasize_Download_u8;                /* Variable for storing the length of memory size */

static uint8 Dcm_dataMemaddrsize_Download_u8;                /* Variable for storing the memory address size*/
static uint8 Dcm_dataFormatIdentifier_u8;           /* Variable for storing the dataFormatIdentifier in tester request */
static uint8 s_dataCompressionMethod_u8;            /* Variable to store the compression method in tester request */
#define DCM_STOP_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
static Dcm_SrvOpStatusType Dcm_stRequestDownloadOpstatus_u8; /* Variable to store the RequestDownload opstatus*/
#define DCM_STOP_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
...
Std_ReturnType Dcm_DcmRequestDownload (Dcm_SrvOpStatusType OpStatus,Dcm_MsgContextType * pMsgContext,Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
    ...
    Std_ReturnType dataretVal_u8;                  /* Variable to store the returnType from DcmAppl API          */
 ...
 *******************************************************************************
 */
void Dcm_Prv_DspReqDownloadConfirmation(
