...
void Dcm_Dsp_RequestTransferExit_Ini (void)
{
    ...
    uint32 transferResponseParameterRecordSize_u32;   /* Variable to store the transferResponseParameterRecord size */
...
Std_ReturnType Dcm_DcmRequestTransferExit (Dcm_SrvOpStatusType OpStatus,Dcm_MsgContextType * pMsgContext,Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
    ...
    uint32 transferRequestParameterRecordSize_u32;    /* Variable to store the transferRequestParameterRecord size  */
    uint32 transferResponseParameterRecordSize_u32;   /* Variable to store the transferResponseParameterRecord size */
