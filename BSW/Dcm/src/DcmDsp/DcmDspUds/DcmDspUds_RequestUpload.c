...
static Dcm_DspRequestUploadStates_ten Dcm_stDspStateRequestUpload_en;   /* RequestUpload state */
#define DCM_STOP_SEC_VAR_CLEARED_UNSPECIFIED /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_32 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
static uint32 Dcm_dataMemoryAddress_Upload_u32; /*Variable to store the memory address requested by the tester*/
static uint32 Dcm_dataMemoryLength_Upload_u32;  /*Variable to store the memory length requested by the tester*/
#define DCM_STOP_SEC_VAR_CLEARED_32 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"

static uint8 Dcm_dataMemdatasize_Upload_u8;                /* Variable for storing the length of memory size */

static uint8 Dcm_dataMemaddrsize_Upload_u8;                /* Variable for storing the memory address size*/
static uint8 Dcm_dataFormatIdentifier_Upload_u8;           /* Variable for storing the dataFormatIdentifier in tester request */
static uint8 s_dataCompressionMethod_Upload_u8;                 /* Variable to store the compression method in tester request */
#define DCM_STOP_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
#define DCM_START_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
static Dcm_OpStatusType Dcm_stRequestUploadOpstatus_u8; /* Variable to store the RequestUpload opstatus*/
#define DCM_STOP_SEC_VAR_CLEARED_8 /*Adding this for memory mapping*/
#include "Dcm_MemMap.h"
...
{
    Dcm_NegativeResponseCodeType dataNegResCode_u8; /* Variable to store Negative response code */
    uint32 dataBlockLength_u32;                    /* Variable to store the block length returned by application */
...
{
    uint8 dataEncryptionMethod_u8;                  /* Variable to store the encryption method in tester request  */
    Std_ReturnType dataretVal_u8 = E_NOT_OK;       /* Variable to store the returnType from DcmAppl API          */
    uint16 idxIndex_u16 = 0u;                            /* Variable to store the index of memory range                */
    uint32 dataBlockLength_u32;                    /* Variable to store the block length returned by application */
 ...
 *******************************************************************************
 */
 void Dcm_Prv_DspReqUploadConfirmation(
