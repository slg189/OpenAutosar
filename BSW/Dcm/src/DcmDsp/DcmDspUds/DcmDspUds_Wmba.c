...
static uint32 Dcm_adrMemoryAddress_u32;    /*Variable to store the memory address requested by the tester*/
static uint32 Dcm_nrWriteMemoryLength_u32; /*Variable to store the memory length requested by the tester*/
...
static uint8 Dcm_nrMemDataSize_u8;              /* variable for storing the data record dataSize_u16*/
static uint8 Dcm_nrMemAddrSize_u8;            /* variable for storing the memory address dataSize_u16*/
        ...
        uint16 * idxLoop_u8)
{
    ...
    if(((uint32)0u != dataMemLength_u32) && (dataMemLength_u32 <= (DCM_MAX_READMEMRANGE - dataMemAddr_u32)))
    {
...
LOCAL_INLINE void Dcm_Prv_WMBATotalCheckLength (
                                       const Dcm_MsgContextType * pMsgContext,
                                       Dcm_NegativeResponseCodeType * dataNegRespCode_u8)
{
    Std_ReturnType dataRetGetIdxWmba_u8; /* Variable to store the return from Binary Search function */
...
LOCAL_INLINE Std_ReturnType Dcm_Prv_WMBAUpdateStatus (
...

   {
      ...
      uint8 idxLoop_u8;
      Std_ReturnType dataRetVal_u8;      /* Variable to store the return from service*/
...
LOCAL_INLINE Dcm_WmbaSupportRet_t Dcm_Prv_WMBASecurityCheck (
                                     uint32 dataSecurityMask_u32,
                                     const Dcm_WMBAConfig_tst * adrWmbaConfig_pcst,
                                     Dcm_NegativeResponseCodeType * adrNegRespCode_pu8)
   {

        Dcm_WmbaSupportRet_t dataRetVal_en; /* return value of this function */
...
static Dcm_WmbaSupportRet_t Dcm_Prv_WmbaAccessCheck_u8 (uint16 idxLoop_u8,
        Dcm_NegativeResponseCodeType * adrNegRespCode_pu8)
{
    ...
    const Dcm_WMBAConfig_tst * adrWmbaConfig_pcst; /* Pointer to WmBA configuration */
    Dcm_WmbaSupportRet_t dataRetVal_en; /* return value of this function */
