...
void Dem_Dependencies_ResetNodeFailed(Dem_ComponentIdType NodeId)
{
    ...
    /* MR12 RULE 20.7 VIOLATION: Macro parameter FUNCTIONNAME in DEM_NODE_CHECK_EVENTS_ATTRIBUTE may not be enclosed in ().*/
...
void Dem_Dependencies_ResetNodeFailedNotRecoverable(Dem_ComponentIdType NodeId)
{
    ...
    /* MR12 RULE 13.5, 20.7 VIOLATION:
     * 13.5: Boolean returning function is identified as an expression causing side effect. This warning can be ignored.
     * 20.7: Macro parameter FUNCTIONNAME in DEM_NODE_CHECK_EVENTS_ATTRIBUTE may not be enclosed in (), because the MACRO is expanded into several commans/lines.
    */
...
void Dem_NodeSetSuspicious(Dem_ComponentIdType NodeId, Dem_boolean_least suspicious)
{
	...
	else
	{
	    ...
	    /* MR12 RULE 20.7 VIOLATION: Macro parameter FUNCTIONNAME in DEM_NODE_CHECK_EVENTS_ATTRIBUTE may not be enclosed in (), because the MACRO is expanded into several commans/lines.*/
