...
static boolean Dem_RecheckNodeNotRecoverableRequested = FALSE;
...
{
    Dem_RecheckNodeNotRecoverableRequested = TRUE;
}
...
static void Dem_RecheckNodeNotRecoverable(void)
{
    ...
    if (Dem_RecheckNodeNotRecoverableRequested)
    {
        for (Dem_NodeIdIteratorNew(&nodeIt); Dem_NodeIdIteratorIsValid(&nodeIt); Dem_NodeIdIteratorNext(&nodeIt))
        {
        ...
        Dem_RecheckNodeNotRecoverableRequested = FALSE;
    }
}
