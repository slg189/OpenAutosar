 ...
 * Mfl_Ceil_f32
 *
 * Returns the integer value determined by rounding the argument toward positive infinity
 *
 * \param   float32   ValValue     Floating-point operand
 * \return  float32                Ceiling of the ValValue
 **********************************************************************************************************************
 */
#if (MFL_CFG_CEIL_F32_LOCATION == MFL_CFG_LOCATION_NORMAL)
    #define MFL_START_SEC_CODE
#elif (MFL_CFG_CEIL_F32_LOCATION == MFL_CFG_LOCATION_SLOW)
    #define MFL_START_SEC_CODE_SLOW
#elif (MFL_CFG_CEIL_F32_LOCATION == MFL_CFG_LOCATION_FAST)
