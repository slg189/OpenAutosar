...
/**
 **********************************************************************************************************************
 * Mfl_IntToFloatCvrt_u16_f32
 *
 * \brief Converts integer to floating point value
 *
 * \param  uint16   ValInteger           Integer value to be converted.
 * \return float32                       Float value for the corresponding Integer input.
 **********************************************************************************************************************
 */

/*** MFL_CFG_INTTOFLOATCVRT_U16_F32_LOCATION ***/
#if (MFL_CFG_INTTOFLOATCVRT_U16_F32_LOCATION != MFL_CFG_LOCATION_INLINE)
    #if (MFL_CFG_INTTOFLOATCVRT_U16_F32_LOCATION == MFL_CFG_LOCATION_NORMAL)
        #define MFL_START_SEC_CODE
    #elif (MFL_CFG_INTTOFLOATCVRT_U16_F32_LOCATION == MFL_CFG_LOCATION_SLOW)
        #define MFL_START_SEC_CODE_SLOW
    #elif (MFL_CFG_INTTOFLOATCVRT_U16_F32_LOCATION == MFL_CFG_LOCATION_FAST)
