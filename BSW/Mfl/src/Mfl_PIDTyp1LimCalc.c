 ...
 * Yn = Yn-1 + Kp * ((1 + Tv / dT) * Xn - (1 - dT / Tn + 2Tv * dT) * Xn-1 + Tv / dT * Xn-2)
 *
 ...
 * Yn = Yn-1 + Kp [ (1 + Tv/dT)(Xn - Xn-1) + Tv/dT * (Xn-2 - Xn-1) + dT/Tn * Xn-1].
 *
 ...
 **********************************************************************************************************************
 */
#if (MFL_CFG_PIDTYP1LIMCALC_LOCATION == MFL_CFG_LOCATION_NORMAL)
    #define MFL_START_SEC_CODE
#elif (MFL_CFG_PIDTYP1LIMCALC_LOCATION == MFL_CFG_LOCATION_SLOW)
    #define MFL_START_SEC_CODE_SLOW
#elif (MFL_CFG_PIDTYP1LIMCALC_LOCATION == MFL_CFG_LOCATION_FAST)
...
void Mfl_PIDTyp1LimCalc(float32 X_f32, Mfl_StatePID_Type* State_cpst, const Mfl_ParamPID_Type* Param_cpst,
                        const Mfl_Limits_Type* Limit_cpst, float32 dT_f32)
{
    /* Calculation: Yn = Yn-1 + Kp [ (1 + Tv/dT)(Xn - Xn-1) + Tv/dT * (Xn-2 - Xn-1) + dT/Tn * Xn-1] */
    /* -------------------------------------------------------------------------------------------- */
    Mfl_PIDTyp1Calc(X_f32, State_cpst, Param_cpst, dT_f32);
