 ...
 * Mfl_SortDescend_f32
 *
 * \brief Sort a float32 array in descending order.
 *
 * Sort a float32 array with the number of Num elements in descending order.
 ...
 ***********************************************************************************************************************
 */
#if (MFL_CFG_SORTDESCEND_F32_LOCATION == MFL_CFG_LOCATION_NORMAL)
    #define MFL_START_SEC_CODE
#elif (MFL_CFG_SORTDESCEND_F32_LOCATION == MFL_CFG_LOCATION_SLOW)
    #define MFL_START_SEC_CODE_SLOW
#elif (MFL_CFG_SORTDESCEND_F32_LOCATION == MFL_CFG_LOCATION_FAST)
...
void Mfl_SortDescend_f32(float32* Array, uint16 Num)
{
    ...
    {
        for(Loop2_qu16 = 0uL; Loop2_qu16 < (Loop1_qu16 - 1u); Loop2_qu16++)
        {
