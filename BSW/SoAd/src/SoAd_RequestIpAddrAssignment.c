                                             ...
                                             const TcpIp_SockAddrType * DefaultRouterPtr)
{
    ...
    SOAD_DET_CHECK_ERROR_RETVAL( ( FALSE == SoAd_InitFlag_b ), SOAD_REQUEST_IPADDR_ASSIGNMENT_API_ID, SOAD_E_NOTINIT, E_NOT_OK )

    /* Check whether SoConId is valid or not */
    SOAD_DET_CHECK_ERROR_RETVAL( (SoAd_CurrConfig_cpst->SoAd_noStaticSockets_uo <= SoConId ), SOAD_REQUEST_IPADDR_ASSIGNMENT_API_ID, SOAD_E_INV_ARG, E_NOT_OK )
