...
\return     -
***************************************************************************************************/
extern void Xcp_CddRxIndication(PduIdType XcpRxPduId, const PduInfoType* XcpRxPduPtr);
...
extern void Xcp_CddTxConfirmation(PduIdType XcpTxPduId, Std_ReturnType result);
#else
extern void Xcp_CddTxConfirmation(PduIdType XcpTxPduId);
#endif
