...
#define XCP_CMD_START_STOP_SYNCH_PREPARE_AVAILABLE (((XCP_ASAM_MAJOR_VERSION <= 1u) && (XCP_ASAM_MINOR_VERSION <= 3u))  ? STD_OFF : STD_ON)
...
/**************************************************************************************************/
/** \defgroup CMD_SET_DAQ_PACKED_MODE SET_DAQ_PACKED_MODE
 *  \ingroup  STD_CMDS
 *  \brief    This command returns detailed information about the implemented protocol layer version
 *            of the XCP slave and the transport layer currently in use.
 *  \sa       Xcp_SubCmdGetVersion
...
#define XCP_SET_DAQ_PACKED_MODE_AVAILABLE            (XCP_CMD_0XC0_AVAILABLE)
#define XCP_SUBCMD_SET_DAQ_PACKED_MODE_ID                        0x01
#define XCP_SUBCMD_SET_DAQ_PACKED_MODE_LENGTH                    4u
#define XCP_SUBRES_SET_DAQ_PACKED_MODE_LENGTH                    1u

#define XCP_DPM_SINGLE_TIMESTAMP_MODE_MASK        0x03u
#define XCP_DPM_SINGLE_TIMESTAMP_OF_LAST_SAMPLE   0x00u
#define XCP_DPM_SINGLE_TIMESTAMP_OF_FIRST_SAMPLE  0x01u

/*state of daq packed mode*/
#define XCP_DPM_DATA_NOT_PACKED                   0x00u
#define XCP_DPM_ELEMENT_GROUPED_DATA_PACKING      0x01u
#define XCP_DPM_EVENT_GROUPED_DATA_PACKING        0x02u


/** \brief SET_DAQ_PACKED_MODE command structure */
typedef struct {
  uint8  CommandCode_u8;                              /**< 0xE0 */
  uint8  SubCommandCode_u8;                           /**< Subcommand : 0x01 */
  uint16 DaqListNum_u16;                              /**< DAQ list number */
...
/** \brief SET_DAQ_PACKED_MODE response structure */
typedef struct {
  uint8  PacketId_u8;                             /**< 0xFF */
}Xcp_ResSetDaqPackedMode_t;


/** \brief GET_DAQ_PACKED_MODE command structure */
#define XCP_GET_DAQ_PACKED_MODE_AVAILABLE            (XCP_CMD_0XC0_AVAILABLE)
#define XCP_SUBCMD_GET_DAQ_PACKED_MODE_ID                        0x02
#define XCP_SUBCMD_GET_DAQ_PACKED_MODE_LENGTH                    4u
#define XCP_SUBRES_GET_DAQ_PACKED_MODE_LENGTH_MODE0              3u
#define XCP_SUBRES_GET_DAQ_PACKED_MODE_LENGTH_MODE2              6u
...
typedef struct {
  uint8  PacketId_u8;                                 /**< 0xFF */
  uint8  Reserved_u8;                                 /**< Reserved */
  uint8  DaqPackedMode_u8;                               /**< 0 = data not packed; 1 = element-grouped data packing; 2 = event-grouped data packing; */
  uint8  DpmTimestampMode_u8;                            /**< This parameter defines the number and meaning of timestamps in packed mode */
  uint16 DpmSampleCount_u16;                              /**< This parameter is the number of samples, which are packed into one DAQ list transmission */
}Xcp_SubResGetDaqPackedMode_t;

#define XCP_DAQ_PACKED_MODE_SUPPORTED               ((XCP_SET_DAQ_PACKED_MODE_AVAILABLE && XCP_DAQ_PACKED_MODE_ENABLED) ? STD_ON : STD_OFF )
...
/***************************************************************************************************/
/** \defgroup SERVICE REQUEST PACKET*/
/***************************************************************************************************/


/** \brief SERVICE response structure */
typedef struct {
  uint8  PacketId_u8;                                   /**< 0xFC */
  uint8  ServiceReqCode_u8;                             /**< ServiceReqCode - 0 for Reset and 1 for Text */
  uint8  OptionalServData_au8[XCP_MAX_CTO - 2u];            /**< OptionalServData*/
}Xcp_ResService_t;
/** \} */
