...
#define XCP_DAQLISTMODE_DTO_CTR         0x08u /**< DTO is transmitted with DTO_CTR counter field */
...
/** \name DTO_CTR_PROPERTIES parameter
 * ```
 *   7 6 5 4 3 2 1 0
 *   | | | | | | | |
 *   | | | | | | | +- RELATED_EVENT_FIXED       0 = can be modified;                         1 = cannot be modified
 *   | | | | | | +--- DAQ_MODE_FIXED            0 = can be modified;                         1 = cannot be modified
 *   | | | | | +----- STIM_MODE_FIXED           0 = can be modified;                         1 = cannot be modified
 *   | | | | +------- RELATED_EVENT_PRESENT     0 = does not have a related event channel;   1 = has a related event channel
 *   | | | +--------- DAQ_MODE_PRESENT          0 = does not support DTO CTR handling;       1 = supports DTO CTR handling
 *   | | +----------- STIM_MODE_PRESENT         0 = does not support DTO CTR handling;       1 = supports DTO CTR handling
 *   | +------------- STIM_CTR_CPY_PRESENT      0 = can save the DTO CTR for later reference;1 = cannot save the DTO CTR for later reference
 *   +--------------- EVT_CTR_PRESENT           0 = This event channel has no cycle counter; 1 = This event channel has a cycle counter
 * ```
 * \{ */
#define XCP_DTO_CTR_PROPERTIES_RELATED_EVENT_FIXED       0x01u     /**< Flag checks if related event channel can be modified or not */
#define XCP_DTO_CTR_PROPERTIES_DAQ_MODE_FIXED            0x02u    /**< Flag checks if DAQ_MODE can be modified or not */
#define XCP_DTO_CTR_PROPERTIES_STIM_MODE_FIXED           0x04u    /**< Flag checks if STIM_MODE can be modified or not */
#define XCP_DTO_CTR_PROPERTIES_RELATED_EVENT_PRESENT     0x08u    /**< Flag checks if related event channel is present or not */
#define XCP_DTO_CTR_PROPERTIES_DAQ_MODE_PRESENT          0x10u    /**< Flag checks if DAQ_MODE is present or not */
#define XCP_DTO_CTR_PROPERTIES_STIM_MODE_PRESENT         0x20u    /**< Flag checks if STIM_MODE is present or not */
#define XCP_DTO_CTR_PROPERTIES_STIM_CTR_CPY_PRESENT      0x40u    /**< Flag checks if STIN_COPY_COUNTER is present or not */
#define XCP_DTO_CTR_PROPERTIES_EVT_CTR_PRESENT           0x80u    /**< Flag checks if EVENT_COUNTER is present or not */
/** \} */
...
#define XCP_DAQLIST_SYNC_PREPSTARTSEL   0x03u   /**< XCP Prepare for Start Selected DAQ list */
...
/** Xcp DTO CTR MODE of an Event Channel */
typedef enum
{
  /* For direction DAQ: When inserting the DTO CTR field */
  XCP_DTO_CTR_DAQ_MODE_INSERT_COUNTER                    = 0u,
  XCP_DTO_CTR_DAQ_MODE_INSERT_STIM_COUNTER_COPY          = 1u,
  /* For direction STIM: When receiving DTOs with CTR field: */
  XCP_DTO_CTR_STIM_MODE_DO_NOT_CHECK_COUNTER             = 2u,
  XCP_DTO_CTR_STIM_MODE_CHECK_COUNTER                    = 3u,
  /* For non-bypass event channels the mode shall be default */
  XCP_MODE_DEFAULT                                       = 4u
}Xcp_DtoCtrMode_t;
...
typedef enum
{
  ...
  XCP_E_PARAM_POINTER                   = 0x12u,  /**< Error when null pointer has been passed as an argument */
  /* RB: Init error */
  ...
  XCP_E_INVALID_SOCON_ID                = 0x42u,  /**< Error for Invalid socket connection id */
  ...
  XCP_E_OPEN_SOCON_FAILED               = 0x54u,  /**< Error open socket connection failed */
  /* RB: Packet checks */
  ...
  XCP_E_INVALIDATE_NVBLOCK_FAILED       = 0xA1U,  /**< Error invalidate NvM block failed */
