...
#  endif /*  (XCP_DAQRAM_SHIFTING == STD_ON) */
    ...
    /* MR12 RULE 11.5, DIR 1.1 VIOLATION: The calling layers ensure correct alignment.
...
boolean Xcp_DaqRamTriggerMovePL(const PduInfoType* XcpPacket, uint8 protLayerId)
{
  ...
  /* MR12 RULE 21.18, 18.1, DIR 4.1 VIOLATION: Access outside the bounds of an array is not possible because there are DET checks. This warning can be ignored */
    ...
    )
  {
    ...
    /* MR12 RULE 11.5, 18.1, 21.18 DIR 1.1, 4.1 VIOLATION: The calling layers ensure correct alignment. Casting over void* is necessary as otherwise some compilers complain
     *                                                     Access outside the bounds of an array is not possible because there are DET checks. This warning can be ignored*/
