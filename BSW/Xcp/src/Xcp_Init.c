...
# endif
  ...
  for (protLayerId = 0; protLayerId < XCP_PL_IDS; protLayerId++)
  {
   ...
   || ((XCP_CALIBRATION_CAL == STD_ON) && (XCP_UPLOAD_DOWNLOAD_MEMORY_ACCESS_BY_APPL == STD_ON)) )
    ...
    /* Debug counter reset */
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_TransmitOkCtr_u16 = 0;
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_TransmitNotOkCtr_u16 = 0;
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_SendResTxConfCtr_u16 = 0;
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_SendResCtr_u16 = 0;
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_SendEvTxConfCtr_u16 = 0;
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_SendEvCtr_u16 = 0;
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_TxConfCtr_u16 = 0;
# if (XCP_SYNCHRONOUS_DATA_ACQUISITION_DAQ == STD_ON)
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_SendDaqTxConfCtr_u16 = 0;
    Xcp_Cleared[protLayerId].Debug.Xcp_Debug_SendDaqCtr_u16 = 0;
# endif
#endif
  }
