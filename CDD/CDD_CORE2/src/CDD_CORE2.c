 ...
 * Component:  CDD_CORE2
 * Description: Testcode for CDD_CORE2
...
#define CDD_CORE2_START_SEC_VAR_INIT_UNSPECIFIED
#include "CDD_CORE2_MemMap.h"
static enum StateCaculation_type StateCaculationCore2 = PREPARE;
#define CDD_CORE2_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "CDD_CORE2_MemMap.h"

#define CDD_CORE2_START_SEC_VAR_INIT_8
#include "CDD_CORE2_MemMap.h"
static uint8 Status_global = 0;
#define CDD_CORE2_STOP_SEC_VAR_INIT_8
#include "CDD_CORE2_MemMap.h"

#define CDD_CORE2_START_SEC_VAR_INIT_32
#include "CDD_CORE2_MemMap.h"
static uint32 Duration_global = 0;  
#define CDD_CORE2_STOP_SEC_VAR_INIT_32
#include "CDD_CORE2_MemMap.h"

#define CDD_CORE2_START_SEC_VAR_INIT_64
#include "CDD_CORE2_MemMap.h"
static float64 CPU_PercentUtilization_global = 0.0;
static float64 MaxUserStackUtilization_f64 = 0.0;
#define CDD_CORE2_STOP_SEC_VAR_INIT_64
#include "CDD_CORE2_MemMap.h"

#define CDD_CORE2_START_SEC_CODE
#include "CDD_CORE2_MemMap.h"
/**********************************************************************************
  Function name		:	CPUUtilizationCore2_func
  Description		:	Fucntion called from client to get the core 2 utilization.
  ...
  Remarks: 
***********************************************************************************/
FUNC (void, CDD_CORE2_CODE) CPUUtilizationCore2_func/* return value & FctID */
(
...
#include "CDD_CORE2_MemMap.h"
/**********************************************************************************
  Function name		:	GetMaxUserStackUtilization_Core2_func
  Description		:	Fucntion called from client to get the maximum stack utilization of core 2
  Parameter	(in)	:	None
  Parameter	(inout)	:	None
  ...
  Remarks: 
***********************************************************************************/
FUNC (Std_ReturnType, AUTOMATIC) GetMaxUserStackUtilization_Core2_func/* return value & FctID */
(
...
/**********************************************************************************
  ...
  Remarks: 
***********************************************************************************/
FUNC (void, CDD_CORE2_CODE) CDD_CORE2_func/* return value & FctID */
(
		void
)
{
	...
	case WAIT_CACULATION:
		...
		if(DTime>TimeSet)
		{
			IdleElapsed = Os_GetIdleElapsedTime(OS_CORE_ID_2);
			StateCaculationCore2 = FINISH_START_CACULATION;
		}
		break;
	...
	UStack_Size = (uint32)&__USTACK2 - (uint32)&__USTACK2_END;
	stack_start = (uint32)&__USTACK2;
