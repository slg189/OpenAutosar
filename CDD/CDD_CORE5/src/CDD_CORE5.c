 ...
 * Component:  CDD_CORE5
 * Description: Testcode for CDD_CORE5
...
#define CDD_CORE5_START_SEC_VAR_INIT_UNSPECIFIED
#include "CDD_CORE5_MemMap.h"
static enum StateCaculation_type StateCaculationCore5 = PREPARE;
#define CDD_CORE5_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "CDD_CORE5_MemMap.h"

#define CDD_CORE5_START_SEC_VAR_INIT_8
#include "CDD_CORE5_MemMap.h"
static uint8 Status_global = 0;
#define CDD_CORE5_STOP_SEC_VAR_INIT_8
#include "CDD_CORE5_MemMap.h"

#define CDD_CORE5_START_SEC_VAR_INIT_32
#include "CDD_CORE5_MemMap.h"
static uint32 Duration_global = 0;  
#define CDD_CORE5_STOP_SEC_VAR_INIT_32
#include "CDD_CORE5_MemMap.h"

#define CDD_CORE5_START_SEC_VAR_INIT_64
#include "CDD_CORE5_MemMap.h"
static float64 CPU_PercentUtilization_global = 0.0;
static float64 MaxUserStackUtilization_f64 = 0.0;
#define CDD_CORE5_STOP_SEC_VAR_INIT_64
#include "CDD_CORE5_MemMap.h"
...
#include "CDD_CORE5_MemMap.h"
/**********************************************************************************
  Function name		:	CPUUtilizationCore5_func
  Description		:	Fucntion called from client to get the core 5 utilization.
  ...
  Remarks: 
***********************************************************************************/
FUNC (void, CDD_CORE5_CODE) CPUUtilizationCore5_func/* return value & FctID */
(
...
#include "CDD_CORE5_MemMap.h"
/**********************************************************************************
  Function name		:	GetMaxUserStackUtilization_Core5_func
  Description		:	Fucntion called from client to get the maximum stack utilization of core 5
  Parameter	(in)	:	None
  Parameter	(inout)	:	None
  ...
  Remarks: 
***********************************************************************************/
FUNC (Std_ReturnType, AUTOMATIC) GetMaxUserStackUtilization_Core5_func/* return value & FctID */
(
...
/**********************************************************************************
  ...
  Remarks: 
***********************************************************************************/
FUNC (void, CDD_CORE5_CODE) CDD_CORE5_func/* return value & FctID */
(
		void
)
{
	...
	case WAIT_CACULATION:
		...
		if(DTime>TimeSet)
		{
			IdleElapsed = Os_GetIdleElapsedTime(OS_CORE_ID_5);
			StateCaculationCore5 = FINISH_START_CACULATION;
		}
		break;
	...
	UStack_Size = (uint32)&__USTACK5- (uint32)&__USTACK5_END;
	stack_start = (uint32)&__USTACK5;
