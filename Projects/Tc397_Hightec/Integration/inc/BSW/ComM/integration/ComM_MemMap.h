...
#elif defined COMM_START_SEC_CONFIG_DATA_POSTBUILD_8
    #define  BSW_START_SEC_CONFIG_DATA_POSTBUILD_8
    #include "Bsw_MemMap.h"
    #undef COMM_START_SEC_CONFIG_DATA_POSTBUILD_8
#elif defined COMM_STOP_SEC_CONFIG_DATA_POSTBUILD_8
    #define  BSW_STOP_SEC_CONFIG_DATA_POSTBUILD_8
    #include "Bsw_MemMap.h"
    #undef COMM_STOP_SEC_CONFIG_DATA_POSTBUILD_8

#elif defined COMM_START_SEC_CONFIG_DATA_POSTBUILD_16
    #define  BSW_START_SEC_CONFIG_DATA_POSTBUILD_16
    #include "Bsw_MemMap.h"
    #undef COMM_START_SEC_CONFIG_DATA_POSTBUILD_16
#elif defined COMM_STOP_SEC_CONFIG_DATA_POSTBUILD_16
    #define  BSW_STOP_SEC_CONFIG_DATA_POSTBUILD_16
    #include "Bsw_MemMap.h"
    #undef COMM_STOP_SEC_CONFIG_DATA_POSTBUILD_16
	
#elif defined COMM_START_SEC_CONFIG_DATA_POSTBUILD_32
    #define  BSW_START_SEC_CONFIG_DATA_POSTBUILD_32
    #include "Bsw_MemMap.h"
    #undef COMM_START_SEC_CONFIG_DATA_POSTBUILD_32
#elif defined COMM_STOP_SEC_CONFIG_DATA_POSTBUILD_32
    #define  BSW_STOP_SEC_CONFIG_DATA_POSTBUILD_32
    #include "Bsw_MemMap.h"
    #undef COMM_STOP_SEC_CONFIG_DATA_POSTBUILD_32
