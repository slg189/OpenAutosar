...
/* Constants of unspecified size.*/
    ...
    #undef MEMMAP_ERROR
/*----------------------------------------------------------------------------*/
/* Constants with attributes that show that they reside in one segment
...
/* Variables of unspecified size.*/
    ...
    #undef MEMMAP_ERROR
/* Variables of unspecified size that are used intensively.*/
#elif defined TCPIP_START_SEC_VAR_FAST_INIT_UNSPECIFIED
    #define  BSW_START_SEC_VAR_FAST_INIT_UNSPECIFIED
    #include "Bsw_MemMap.h"
    #undef TCPIP_START_SEC_VAR_FAST_INIT_UNSPECIFIED
    #undef MEMMAP_ERROR
#elif defined TCPIP_STOP_SEC_VAR_FAST_INIT_UNSPECIFIED
    #define  BSW_STOP_SEC_VAR_FAST_INIT_UNSPECIFIED
    #include "Bsw_MemMap.h"
    #undef TCPIP_STOP_SEC_VAR_FAST_INIT_UNSPECIFIED
    #undef MEMMAP_ERROR
/* Normal code section.*/
    ...
    #undef MEMMAP_ERROR
#elif defined TCPIP_START_SEC_CALLOUT_CODE
    #define  BSW_START_SEC_DEFAULT_CODE
    #include "Bsw_MemMap.h"
    #undef TCPIP_START_SEC_CALLOUT_CODE
    #undef MEMMAP_ERROR
#elif defined TCPIP_STOP_SEC_CALLOUT_CODE
    #define  BSW_STOP_SEC_DEFAULT_CODE
    #include "Bsw_MemMap.h"
