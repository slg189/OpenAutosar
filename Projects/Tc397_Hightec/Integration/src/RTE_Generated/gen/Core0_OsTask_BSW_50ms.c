/** @file     Core0_OsTask_BSW_50ms.c
  *
  * @brief    Task Core0_OsTask_BSW_50ms body
  *
...
#include "Core0_OsTask_BSW_50ms.h"
...
#define RTE_CORE0_OSTASK_BSW_50MS_START_SEC_CODE
#include "Rte_MemMap.h"
TASK(Core0_OsTask_BSW_50ms)
{
   ...
   TerminateTask();
} /* Core0_OsTask_BSW_50ms */
#define RTE_CORE0_OSTASK_BSW_50MS_STOP_SEC_CODE
#include "Rte_MemMap.h"
