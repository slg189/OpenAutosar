/** @file     Core3_OsTask_ASW_10ms.c
  *
  * @brief    Task Core3_OsTask_ASW_10ms body
  *
...
#include "Core3_OsTask_ASW_10ms.h"
...
#define RTE_CORE3_OSTASK_ASW_10MS_START_SEC_CODE
#include "Rte_MemMap.h"
TASK(Core3_OsTask_ASW_10ms)
{
   ...
   {
      /* Box: CPT_CDD_CORE3 begin */
      CDD_CORE3_func();
      /* Box: CPT_CDD_CORE3 end */
   }
   {
      /* Box: CPT_ASW_CORE3 begin */
      RE_CORE3_SWC_func();
      /* Box: CPT_ASW_CORE3 end */
   }
   /* Box: Implicit Buffer Flush begin */
   /* Box: Implicit Buffer Flush end */
   TerminateTask();
} /* Core3_OsTask_ASW_10ms */
#define RTE_CORE3_OSTASK_ASW_10MS_STOP_SEC_CODE
#include "Rte_MemMap.h"
