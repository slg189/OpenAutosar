/** @file     Core4_OsTask_ASW_10ms.c
  *
  * @brief    Task Core4_OsTask_ASW_10ms body
  *
...
#include "Core4_OsTask_ASW_10ms.h"
...
#define RTE_CORE4_OSTASK_ASW_10MS_START_SEC_CODE
#include "Rte_MemMap.h"
TASK(Core4_OsTask_ASW_10ms)
{
   ...
   {
      /* Box: CPT_CDD_CORE4 begin */
      CDD_CORE4_func();
      /* Box: CPT_CDD_CORE4 end */
   }
   {
      /* Box: CPT_ASW_CORE4 begin */
      RE_CORE4_SWC_func();
      /* Box: CPT_ASW_CORE4 end */
   }
   /* Box: Implicit Buffer Flush begin */
   /* Box: Implicit Buffer Flush end */
   TerminateTask();
} /* Core4_OsTask_ASW_10ms */
#define RTE_CORE4_OSTASK_ASW_10MS_STOP_SEC_CODE
#include "Rte_MemMap.h"
