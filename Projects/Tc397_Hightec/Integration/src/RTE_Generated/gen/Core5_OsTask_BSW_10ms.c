/** @file     Core5_OsTask_BSW_10ms.c
  *
  * @brief    Task Core5_OsTask_BSW_10ms body
  *
...
#include "Core5_OsTask_BSW_10ms.h"
...
#define RTE_CORE5_OSTASK_BSW_10MS_START_SEC_CODE
#include "Rte_MemMap.h"
TASK(Core5_OsTask_BSW_10ms)
{
   ...
   TerminateTask();
} /* Core5_OsTask_BSW_10ms */
#define RTE_CORE5_OSTASK_BSW_10MS_STOP_SEC_CODE
#include "Rte_MemMap.h"
