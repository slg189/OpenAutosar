...
#define RTE_OSAPPLICATION_CORE3_START_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
VAR(uint16, RTE_DATA) Rte_ResourceCount_OsApplication_Core3 = 0;
#define RTE_OSAPPLICATION_CORE3_STOP_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"

#define RTE_OSAPPLICATION_CORE4_START_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
VAR(uint16, RTE_DATA) Rte_ResourceCount_OsApplication_Core4 = 0;
#define RTE_OSAPPLICATION_CORE4_STOP_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"

#define RTE_OSAPPLICATION_CORE5_START_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
VAR(uint16, RTE_DATA) Rte_ResourceCount_OsApplication_Core5 = 0;
#define RTE_OSAPPLICATION_CORE5_STOP_SEC_VAR_CLEARED_16
#include "Rte_MemMap.h"
...
#include "Rte_MemMap.h"
VAR(uint16, RTE_DATA) Rte_SpinlockCount[] = {
   0,
   0,
   0,
   0,
...
Rte_Start(void)                          /* [$Satisfies $SWS 2569] */
{
   ...
   Rte_Resources[OsApplication_Core3] = RTE_REF_FROM_RESOURCE(RTE_RESOURCE_OS_APP_OsApplication_Core3);
   Rte_Resources[OsApplication_Core4] = RTE_REF_FROM_RESOURCE(RTE_RESOURCE_OS_APP_OsApplication_Core4);
   Rte_Resources[OsApplication_Core5] = RTE_REF_FROM_RESOURCE(RTE_RESOURCE_OS_APP_OsApplication_Core5);
   ...
   Rte_ResourceCount[OsApplication_Core3] = &Rte_ResourceCount_OsApplication_Core3;
   Rte_ResourceCount[OsApplication_Core4] = &Rte_ResourceCount_OsApplication_Core4;
   Rte_ResourceCount[OsApplication_Core5] = &Rte_ResourceCount_OsApplication_Core5;
   ...
   /* Must be set before Rte_IModeInit is called */
   Rte_Initialized = TRUE;                              /* [$Satisfies $SWS 2535] [$Satisfies $SWS 2536] */

   Rte_IModeInit();                                     /* [$Satisfies $SWS 2544] */
