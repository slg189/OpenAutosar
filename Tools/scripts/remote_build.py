...
用法：
    python Tools/scripts/remote_build.py                          # 用默认 server
    python Tools/scripts/remote_build.py --server build_server_01
    python Tools/scripts/remote_build.py --auto                   # 自动调度
    python Tools/scripts/remote_build.py --extra "BUILD_TYPE=Release -j32"
"""
import argparse
import os
import sys

HERE = os.path.dirname(os.path.abspath(__file__))            # Tools/scripts
...
def main():
    ...
    ap.add_argument('--project', default='Projects/Demo_Tc387')
